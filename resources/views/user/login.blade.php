...
.form-container .tooltip.top .tooltip-arrow {
  border-top-color:#A2A6A7 !important;
}
...
<div class="container">
    <div class="row">
      ...
      <div class="col-md-4">
          <div class="container" style="margin-left: 200px; margin-right: -10px; "> 
    <br>
 
    <!--<h1><b>Signin</b></h1>-->
    
     
 <h1 style="color:#fff;opacity: 0.9;font-size: 29px;font-family: Georgia;"> Crodrive Offers: Upto 90% Off on first 1000 rides.</h1>
 <h2 style="color:#fff;opacity: 0.9;font-size: 29px;">Coming Soon</h2>
    <h3 style="color:#fff;opacity: 0.9;font-size: 29px;">We are ready to launch our New Website</h3>
   </div>
...
@section('content')
    ...
    {!! Form::open([
        ...
        <div class="row submit-row" style="margin: 0px;font-size: 20px;color: #5acae9;">
        <button id="confirmsignup" name="confirmsignup" class="btn btn-success" style="color: #0c0c0c;border-color: #fff;background-color: #fff;">{!! Form::submit('Submit') !!}</button>
        </div>
      </div>
      </div>
      </form>
